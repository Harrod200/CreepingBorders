# Creeping Borders — Handover Notes v5

Date: 2026-09-21
Prepared after session 4 (contiguity spec locked). Supersedes v4. Read the
locked spec section below first — it is the authoritative behavioural contract.
Decision log: Docs/Handover Decision and Findings Log.md (D41–D46).
