...
namespace TMPro.Examples
{
	...
	{
		// Token: 0x06001FAF RID: 8111 RVA: 0x000A3FFC File Offset: 0x000A21FC
		private void Start()
		{
			for (int i = 0; i < this.NumberOfNPC; i++)
			{
				if (this.SpawnType == 0)
				{
					...
					gameObject.transform.position = new Vector3(global::UnityEngine.Random.Range(-95f, 95f), 0.25f, global::UnityEngine.Random.Range(-95f, 95f));
				...
				else if (this.SpawnType == 1)
				{
					...
					gameObject2.transform.position = new Vector3(global::UnityEngine.Random.Range(-95f, 95f), 0.25f, global::UnityEngine.Random.Range(-95f, 95f));
				...
				else if (this.SpawnType == 2)
				{
					...
					gameObject3.transform.position = new Vector3(global::UnityEngine.Random.Range(-95f, 95f), 5f, global::UnityEngine.Random.Range(-95f, 95f));
