...
namespace LapinerTools.Steam.Data
{
	...
	{
		// Token: 0x060021FC RID: 8700 RVA: 0x000B1CCC File Offset: 0x000AFECC
		...
		// Token: 0x060021FD RID: 8701 RVA: 0x000B20C3 File Offset: 0x000B02C3
		public static ErrorEventArgs CreateSteamNotInit()
		{
			return new ErrorEventArgs("Steam must be running!");
		}

		// Token: 0x060021FE RID: 8702 RVA: 0x000B20CF File Offset: 0x000B02CF
		...
		// Token: 0x060021FF RID: 8703 RVA: 0x000B20DB File Offset: 0x000B02DB
		public static ErrorEventArgs Create(EResult p_result)
		{
			return new ErrorEventArgs(ErrorEventArgs.ERROR_MSG(p_result));
		}

		// Token: 0x06002200 RID: 8704 RVA: 0x000B20E8 File Offset: 0x000B02E8
		public ErrorEventArgs()
		{
			base.IsError = true;
		}

		// Token: 0x06002201 RID: 8705 RVA: 0x000B20F7 File Offset: 0x000B02F7
